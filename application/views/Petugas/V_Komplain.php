 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">
      <div class="box">
        <div class="box-body">
          <a href="<?php echo base_url() ?>Petugas/Komplain" class="btn btn-info"><i class="fa fa-refresh"></i></a>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <!-- ################# -->
                  <form role="form" action="<?php echo base_url() ?>Petugas/Komplain/tambah" method="POST">
                    <div class="box-body">
