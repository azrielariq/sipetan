...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <!-- Logo -->
    <a href="<?php echo base_url() ?>Petugas/Dashboard" class="logo">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="<?php echo ($nav == 'dashboard' ? 'active' : '') ?>">
          <a href="<?php echo base_url() ?>Petugas/Dashboard"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a>
        </li>
        <li class="<?php echo ($nav == 'jimpitan' ? 'active' : '') ?>">
          <a href="<?php echo base_url() ?>Petugas/Jimpitan"><i class="fa fa-money"></i> <span>Jimpitan</span></a>
        </li>
        <li class="<?php echo ($nav == 'komplain' ? 'active' : '') ?>">
          <a href="<?php echo base_url() ?>Petugas/Komplain"><i class="fa fa-deaf"></i> <span>Komplain</span></a>
        </li>
