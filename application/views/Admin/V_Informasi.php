 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">
      <div class="box">
        <div class="box-body">
          <a href="<?php echo base_url() ?>Admin/Informasi" class="btn btn-info"><i class="fa fa-refresh"></i></a>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <a onclick="return confirm('Are you sure you want to delete this item?');" class="btn btn-danger btn-sm" href="<?php echo base_url() ?>Admin/Informasi/hapus/<?php echo $row['id']?>"><i class="fa fa-trash"></i></a>
                </td>
              </tr>
              <?php } ?>
            </tbody>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <!-- ################# -->
                  <form role="form" action="<?php echo base_url() ?>Admin/Informasi/tambah" method="POST">
                    <div class="box-body">
                      ...
                      <div class="form-group">
                        ...
                        <textarea name="informasi" class="form-control" id="exampleFormControlTextarea1" rows="4" placeholder="Tulis informasi"></textarea>
                      </div>
                    </div>
                    <!-- /.box-body -->
